...
namespace TMDT.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(TmdtContext context)
        {
            _context = context;
        }
        ...
        {
            var tmdtContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await tmdtContext.ToListAsync());
        }
